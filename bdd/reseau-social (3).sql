...
--
-- Hôte : 127.0.0.1
-- Généré le : mar. 09 avr. 2024 à 11:26
...
INSERT INTO `events` (`id`, `user_id`, `title`, `description`, `date_time`) VALUES
(15, 12, 'maryage de khalef et kawter', 'le meilleur mayage des amoureux', '2024-04-25 20:00:00'),
(16, 12, 'maryage de khalef et kawter', 'le meilleur mayage des amoureux', '2024-04-25 20:00:00'),
(17, 12, 'maryage de khalef et kawter', 'le meilleur mayage des amoureux', '2024-04-25 20:00:00'),
(18, 12, 'kjn', 'll;lml,kl,l, klnkjb', '0000-00-00 00:00:00');
...
(13, '2024-03-29 13:05:41', 'salut\r\n', 12, 11),
(14, '2024-03-29 13:11:43', 'salut\r\n', 12, 11),
(15, '2024-03-29 13:11:51', 'cv', 12, 11),
(16, '2024-03-29 13:16:29', 'cv', 12, 11),
(17, '2024-03-29 13:16:40', 'et toi', 12, 11),
(18, '2024-03-29 13:16:54', 'haldoullah', 12, 11),
(19, '2024-03-29 13:21:10', 'cv', 12, 11),
(20, '2024-03-29 13:21:34', 'cv', 12, 11),
(21, '2024-03-29 13:22:47', 'cv', 12, 11),
(22, '2024-03-29 13:22:57', 'tu vas bien', 12, 11),
(23, '2024-03-29 13:26:17', 'cv', 12, 11),
(24, '2024-03-29 13:30:46', 'cv', 12, 11),
(25, '2024-03-29 13:31:37', 'merci pour ces message ', 11, 12),
(26, '2024-03-29 13:32:18', 'je suis trés content \n\n', 11, 12),
(27, '2024-03-29 13:40:17', 'couou', 11, 12),
(28, '2024-03-29 13:41:04', 'hi', 11, 12),
(29, '2024-03-29 20:50:11', 'cv', 12, 11),
(30, '2024-04-02 11:23:55', 'azul', 12, 13),
(31, '2024-04-02 11:32:31', 'ugiiggi', 12, 11),
(32, '2024-04-02 11:32:46', '', 12, 11),
(33, '2024-04-02 12:59:59', 'cv', 12, 13),
(34, '2024-04-02 13:00:13', 'hjvhyu\n', 12, 11),
(35, '2024-04-02 13:27:35', 'cc', 12, 13),
(36, '2024-04-02 13:27:40', 'hgui\n', 12, 13),
(37, '2024-04-02 13:33:18', 'kgfpier,', 12, 11),
(38, '2024-04-02 13:36:37', 'tret', 12, 11);
...
(22, 13, 'azuuul', 'azzuuul', '../upload/post/1711676183416535671.jpeg', ''),
(23, 12, 'nouvelle photos ', 'logo real madrid logo real madrid logo real madrid', '../upload/post/17126540481138814239.jpg', '');
...
(13, '../upload/default/default_banner.png', '../upload/default/default_pp.png', 'Ceci est la description de jsk', 13),
(14, '../upload/default/default_banner.png', '../upload/default/default_pp.png', 'Ceci est la description de 12', 14);
...
(13, 'jsk', 'jsk', 'jsk@gmail.com', 'France', '$2y$10$ilFlvYCZEFazu43fQUrVAeEpF/QVWxNy6v9XQ.anRDvBmNkCIPiL2', '2000-07-30', '0151512012', '0', 'jsk'),
(14, 'dounia', 'donit', 'dounia@gmail.com', 'France', '$2y$10$yYjHKMuZT53qoOkEuK/cw.rctTxV54HMN46LLx9etHNjRPBHOEBTK', '2019-08-08', '0111111111', '0', '12');
...
ALTER TABLE `participants`
  ADD PRIMARY KEY (`id`),
  ADD KEY `event_id_foreign` (`event_id`),
  ADD KEY `user_id_foreign` (`user_id`);
