...
<body>
    <div class="container">
        <div class="row">
            <div class="col">
                <img src="../Page HTML/image/logo.png" class="logo" alt="logo">
            </div>
            <div class="col">
                <div class="formulaire">
                    <h1>Bienvenue sur MeetCha</h1>

                    <form action="" method="POST" class="row g-3 needs-validation" novalidate>
                        <div class="col-md-4">
                            <label for="validationCustom03" class="form-label">Nom d'utilisateur</label>
                            <input name="username" type="text" class="form-control" id="validationCustom03" placeholder="Nom d'utilisateur" required>
